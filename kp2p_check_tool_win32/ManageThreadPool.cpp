...
//		aFullpath32, // 32-bit
//		aFullpath64,		 // 64-bit not provided
//		&pid,
...
//	if (nt != 0)
//	{
//		printlog("RhInjectLibrary failed with error code = %d\n", nt);
...
//		printlog("Library injected successfully.");
//	}
//	return TRUE;
//}
//
...
//		}
//		if (!bIsExist && (pManage->m_MonitorObjectList)[i]->m_IsExist) {
...
//			printlog("%s exit", (pManage->m_MonitorObjectList)[i]->m_ObjectName.c_str());
//		}
//		i += 1;
...
//{
//	printlog("CommunicateWithServerProc");
//	int nRet = -1;
//	BOOL bRet = FALSE;
...
//
//RECONNECT:
//	pConnector = new CConnector(pManage, REMOTE_SERVER_IP, REMOTE_SERVER_IP, REMOTE_PORT, CConnector::STATE_CLIENT);
//	if (NULL == pConnector) {
//		printlog("connect web server failed!");
//	} else {	
